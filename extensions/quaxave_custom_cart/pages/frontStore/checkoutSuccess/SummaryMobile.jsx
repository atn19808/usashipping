...
// NOTE: consider re-write the original Summary and CustomerInfo to make the Reusable and Extendable
export default function SummaryMobile({ order, setting: { priceIncludingTax } }) {
  return (
    <Area
...
export const layout = {
  areaId: 'checkoutSuccessSummaryMobile',
  sortOrder: 10
};
